...
// The thin shell is version-aligned with the release it ships in (v1.3.0). No SDK or extra
...
internal sealed class InstallerWindow : Form
{
    ...
    internal InstallerWindow(string packageRoot, string initialTarget, string powerShellHost, string exeDirectory)
    {
        ...
        header.Controls.Add(new Label { Text = "Codex × DSH Team Toolkit  /  v1.3.0", ForeColor = Color.FromArgb(100, 116, 139), AutoSize = true, Location = new Point(2, 48) });
